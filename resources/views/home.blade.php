...
@section('container')
<div class="p-4 p-md-5 mb-4 text-white rounded bg-success mt-5 shadow-sm">
    <div class="row">
        <div class="col-md-6 px-0">
            ...
            <a href="/aspirasi" class="btn btn-light btn-lg">Tulis</a>
        </div>
...
<div class="col-12 mb-10">
    ...
    <div class="col-12">
        <a href="/aspirasi" class="btn btn-success fw-bold">Yuk Ajukan Aspirasi</a>
    </div>
</div>
@endsection
